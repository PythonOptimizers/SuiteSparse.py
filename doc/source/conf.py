...
project = u'SuiteSparse.py'
copyright = u'2015-2016, Dominique Orban, Sylvain Arreckx and Nikolaj van Omme'
...
try:
    from suitesparse import __version__
    # The short X.Y version.
...
htmlhelp_basename = 'SuiteSparse.py'
...
latex_documents = [
  ('contents', 'suitesparse_py_manual.tex', ur"SuiteSparse.py's manual",
