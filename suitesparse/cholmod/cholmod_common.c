...
#define __PYX_HAVE__suitesparse__cholmod__cholmod_common
#define __PYX_HAVE_API__suitesparse__cholmod__cholmod_common
#include "cholmod.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char *__pyx_f[] = {
  "suitesparse/cholmod/cholmod_common.pyx",
};
...
/* Module declarations from 'suitesparse.cholmod.cholmod_common' */
#define __Pyx_MODULE_NAME "suitesparse.cholmod.cholmod_common"
int __pyx_module_is_main_suitesparse__cholmod__cholmod_common = 0;
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcholmod_common(void); /*proto*/
PyMODINIT_FUNC initcholmod_common(void)
#else
PyMODINIT_FUNC PyInit_cholmod_common(void); /*proto*/
PyMODINIT_FUNC PyInit_cholmod_common(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cholmod_common(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cholmod_common", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_suitesparse__cholmod__cholmod_common) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "suitesparse.cholmod.cholmod_common")) {
      if (unlikely(PyDict_SetItemString(modules, "suitesparse.cholmod.cholmod_common", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 3; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init suitesparse.cholmod.cholmod_common", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init suitesparse.cholmod.cholmod_common");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
