...
from suitesparse.cholmod.cholmod_solver_base_INT64_t_FLOAT64_t cimport numpy_ndarray_to_cholmod_dense
...
cdef class SPQRSolverBase_INT64_t_FLOAT64_t(Solver_INT64_t_FLOAT64_t):
