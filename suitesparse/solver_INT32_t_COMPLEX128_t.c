...
/* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":26
 * 
 *     @property
...
/* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":37
 *     # Common functions
 *     ####################################################################################################################
...
static PyObject *__pyx_pf_11suitesparse_27solver_INT32_t_COMPLEX128_t_27Solver_INT32_t_COMPLEX128_t_8analyze(struct __pyx_obj_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t *__pyx_v_self, PyObject *__pyx_v_args, PyObject *__pyx_v_kwargs) {
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":47
 * 
 *     def analyze(self, *args, **kwargs):
 *         force_analyze = kwargs.get('force_analyze', False)             # <<<<<<<<<<<<<<
 *         if self.__verbose and force_analyze:
 ...
 */
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":48
 *     def analyze(self, *args, **kwargs):
 *         force_analyze = kwargs.get('force_analyze', False)
 *         if self.__verbose and force_analyze:             # <<<<<<<<<<<<<<
 *             print("Force analyze.")
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":49
 *         force_analyze = kwargs.get('force_analyze', False)
 *         if self.__verbose and force_analyze:
 *             print("Force analyze.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":52
 * 
 *         if force_analyze or not self.__analyzed:
 *             start_time = time.clock()             # <<<<<<<<<<<<<<
 *             self._analyze(*args, **kwargs)
 ...
 */
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":98
 *         lines.append("Performance:")
 *         lines.append("------------")
 *         lines.append("")             # <<<<<<<<<<<<<<
 *         lines.append("Analyze: %f" % self.__analyze_time)
 ...
 * 
 */
  __pyx_t_1 = __Pyx_GetNameInClass((PyObject *)__pyx_ptype_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t, __pyx_n_s_solver_name); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem((PyObject *)__pyx_ptype_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t->tp_dict, __pyx_n_s_solver_name, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 26; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
  __pyx_t_1 = __Pyx_GetNameInClass((PyObject *)__pyx_ptype_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t, __pyx_n_s_A); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem((PyObject *)__pyx_ptype_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t->tp_dict, __pyx_n_s_A, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  PyType_Modified(__pyx_ptype_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t);
