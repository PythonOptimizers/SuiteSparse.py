 ...
 */
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":56
 *         # b could be a sparse/denses matrix/vector
 *         b = self._solve(*args, **kwargs)
 *         self.__solve_time = time.clock() - start_time             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_11suitesparse_27solver_INT32_t_COMPLEX128_t_27Solver_INT32_t_COMPLEX128_t_12analyze(struct __pyx_obj_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t *__pyx_v_self, PyObject *__pyx_v_args, PyObject *__pyx_v_kwargs) {
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":61
 * 
 *     def analyze(self, *args, **kwargs):
 *         force_analyze = kwargs.get('force_analyze', False)             # <<<<<<<<<<<<<<
 *         if self.__verbose and force_analyze:
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":66
 * 
 *         if force_analyze or not self.__analyzed:
 *             start_time = time.clock()             # <<<<<<<<<<<<<<
 *             self._analyze(*args, **kwargs)
...
static PyObject *__pyx_pf_11suitesparse_27solver_INT32_t_COMPLEX128_t_27Solver_INT32_t_COMPLEX128_t_14factorize(struct __pyx_obj_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t *__pyx_v_self, PyObject *__pyx_v_args, PyObject *__pyx_v_kwargs) {
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":72
 * 
 *     def factorize(self, *args, **kwargs):
 *         force_factorize = kwargs.get('force_factorize', False)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":75
 * 
 *         if self.__verbose and force_factorize:
 *             print("Force factorize.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":80
 * 
 *         if force_factorize or not self.__factorized:
 *             start_time = time.clock()             # <<<<<<<<<<<<<<
 *             self._factorize(*args, **kwargs)
...
/* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":88
 *     # Special functions
 *     ####################################################################################################################
 *     def __call__(self, B):             # <<<<<<<<<<<<<<
 *         return self.solve(B)
...
static PyObject *__pyx_pf_11suitesparse_27solver_INT32_t_COMPLEX128_t_27Solver_INT32_t_COMPLEX128_t_16__call__(struct __pyx_obj_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t *__pyx_v_self, PyObject *__pyx_v_B) {
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":89
 *     ####################################################################################################################
 *     def __call__(self, B):
 *         return self.solve(B)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_11suitesparse_27solver_INT32_t_COMPLEX128_t_27Solver_INT32_t_COMPLEX128_t_18__mul__(PyObject *__pyx_v_self, PyObject *__pyx_v_B) {
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":92
 * 
 *     def __mul__(self, B):
 *         return self.solve(B)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_11suitesparse_27solver_INT32_t_COMPLEX128_t_27Solver_INT32_t_COMPLEX128_t_28_stats(CYTHON_UNUSED struct __pyx_obj_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_args, CYTHON_UNUSED PyObject *__pyx_v_kwargs) {
  ...
  /* "suitesparse/solver_INT32_t_COMPLEX128_t.pyx":140
 *         Returns a string with specialized statistics about the factorization.
 *         """
 *         raise NotImplementedError()             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Solver_INT32_t_COMPLEX128_t", (PyObject *)&__pyx_type_11suitesparse_27solver_INT32_t_COMPLEX128_t_Solver_INT32_t_COMPLEX128_t) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
