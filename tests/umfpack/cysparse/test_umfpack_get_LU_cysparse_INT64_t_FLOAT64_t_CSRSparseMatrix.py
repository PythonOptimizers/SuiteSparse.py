...
#######################################################################
class CySparseUmfpackget_LUNoSymmetryNoZero_CSRSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
    ...
    def test_factorization_element_by_element(self):
        ...
        P_mat = PermutationLLSparseMatrix(P=P, size=SIZE, dtype=FLOAT64_T, itype=INT64_T)
        Q_mat = PermutationLLSparseMatrix(P=Q, size=SIZE, dtype=FLOAT64_T, itype=INT64_T)

        R_mat = None
        if do_recip:
            R_mat = LLSparseMatrix(size=SIZE, dtype=FLOAT64_T, itype=INT64_T)
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetryNoZero_CSRSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUNoSymmetrySWithZero_CSRSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):

        self.A = LinearFillLLSparseMatrix(size=SIZE, dtype=FLOAT64_T, itype=INT64_T, store_zero=True)
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetrySWithZero_CSRSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
