...
#######################################################################
class CySparseUmfpackget_LUNoSymmetryNoZero_CSRSparseMatrix_INT32_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetryNoZero_CSRSparseMatrix_INT32_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUNoSymmetrySWithZero_CSRSparseMatrix_INT32_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
