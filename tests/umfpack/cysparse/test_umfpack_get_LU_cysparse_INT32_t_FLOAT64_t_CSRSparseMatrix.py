...
#######################################################################
class CySparseUmfpackget_LUNoSymmetryNoZero_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetryNoZero_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUNoSymmetrySWithZero_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetrySWithZero_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
