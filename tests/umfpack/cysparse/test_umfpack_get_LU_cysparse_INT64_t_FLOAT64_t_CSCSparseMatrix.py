...
#######################################################################
class CySparseUmfpackget_LUNoSymmetryNoZero_CSCSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetryNoZero_CSCSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUNoSymmetrySWithZero_CSCSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetrySWithZero_CSCSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
