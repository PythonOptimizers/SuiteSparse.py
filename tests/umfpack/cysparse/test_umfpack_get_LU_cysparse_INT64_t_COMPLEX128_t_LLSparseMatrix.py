...
#######################################################################
class CySparseUmfpackget_LUNoSymmetryNoZero_LLSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetryNoZero_LLSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUNoSymmetrySWithZero_LLSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseUmfpackget_LUWithSymmetrySWithZero_LLSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
